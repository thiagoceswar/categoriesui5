sap.ui.define([
	...
	return BaseController.extend("sap.treinamento.prjcat.projectcategories.controller.Worklist", {
		...
		onSearch : function (oEvent) {
            ...
            var name = this.getView().byId("inNome").getValue();

            var aTableSearchState = [];

            if(id){
                aTableSearchState.push(new Filter("ID", FilterOperator.EQ, id));
            }
		...
		onValueHelpClose: function (oEvent) {
			...
			this.byId("inNome").setValue(oSelectedItem.getDescription());
		},

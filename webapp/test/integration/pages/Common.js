sap.ui.define([
	...
	return Opa5.extend("sap.treinamento.prjcat.projectcategories.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["sap/treinamento/prjcat/projectcategories/localService/mockserver"], function (mockserver) {

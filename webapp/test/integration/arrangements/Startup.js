sap.ui.define([
	"sap/ui/test/Opa5",
	"sap/treinamento/prjcat/projectcategories/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("sap.treinamento.prjcat.projectcategories.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "sap.treinamento.prjcat.projectcategories",
					async: true
				},
				hash: oOptions.hash,
